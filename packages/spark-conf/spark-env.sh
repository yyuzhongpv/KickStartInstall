...
export JAVA_HOME=/opt/cscloud/jdk-latest/
export SPARK_HOME=/opt/cscloud/spark-latest/
export SPARK_MATER_PORT=7077
export SPARK_MASTER_IP=172.30.50.2
export SPARK_WORKER_MEMORY=48g
export SPARK_DRIVER_MEMORY=16g
export SPARK_MASTER_WEBUI_PORT=8000
export SPARK_WORKER_CORES=24
#export SPARK_MASTER_OPTS="-Dspark.deploy.defaultCores=112"
#export SPARK_LIBRARY_PATH=/opt/cscloud/spark-latest/lib
